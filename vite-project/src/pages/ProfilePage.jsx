...
const Sidebar = () => {
  const menu = [
    ...
    { name: "Job Management", icon: "admin_panel_settings" },
  ];

  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-[#eef2f7] border-r border-gray-200 p-5 flex flex-col">
      <div>
        <h1 className="text-blue-500 font-bold text-lg mb-6">
          SkillMatch AI
        </h1>
